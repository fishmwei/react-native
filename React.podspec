...
filePath = File.join(__dir__, "package.json");

puts filePath

package = JSON.parse(File.read("/Volumes/Code/github-code/hmw-react-native/package.json"));
...
# else
  source[:tag] = "batchedBridge-crash"
# end
...
Pod::Spec.new do |s|
  ...
  s.subspec "RCTWebSocket" do |ss|
    ...
    ss.source_files         = "Libraries/WebSocket/*.{h,m}", "Libraries/Blob/*.{h,m}"
    ss.preserve_paths       = "Libraries/Blob/*.js"
  end
