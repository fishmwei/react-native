...
source = { :git => 'https://github.com/fishmwei/react-native.git', :tag=>'spec-0.54.2' }
...
Pod::Spec.new do |s|
  ...
  s.subspec "Core" do |ss|
    ...
    ss.exclude_files        = "**/__tests__/*",
                              ...
                              "ReactCommon/yoga/*",
                              "React/Cxx*/*",
                              "React/Modules/RCTDevSettings.{h,mm}",
  ...
  s.subspec "CxxBridge" do |ss|
    ...
    ss.dependency             "boost-for-react-native"
    ss.dependency             "React/Core"
    ss.dependency             "React/cxxreact"
    ss.dependency             "React/DevSupport"
